...
import com.myrontuttle.evolve.CandidateFactory;
import com.myrontuttle.evolve.EvaluatedCandidate;
import com.myrontuttle.evolve.EvolutionEngine;
...
import com.myrontuttle.evolve.SelectionStrategy;
import com.myrontuttle.evolve.TerminationCondition;
import com.myrontuttle.evolve.termination.GenerationCount;
...
public class IslandEvolution<T>
{
                           ...
                           Random rng)
    {
        ...
        for (int i = 0; i < islands.size(); i++)
        {
            ...
            {
                public void populationUpdate(PopulationStats<? extends T> PopulationStats)
                {
                    for (IslandEvolutionObserver<? super T> islandObserver : observers)
                    {
                        islandObserver.islandPopulationUpdate(islandIndex, PopulationStats);
                    }
                }
            });
        }
