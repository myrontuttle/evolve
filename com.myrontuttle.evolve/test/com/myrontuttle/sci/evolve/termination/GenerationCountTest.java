...
public class GenerationCountTest
{
    ...
    public void testGenerationCounts()
    {
        ...
        PopulationStats<Object> data = new PopulationStats<Object>(0, new Object(), 0, 0, 0, true, 2, 0, 3, 100);
        ...
        data = new PopulationStats<Object>(0, new Object(), 0, 0, 0, true, 2, 0, 4, 100);
