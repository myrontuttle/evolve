...
public class ElapsedTimeTest
{
    ...
    public void testElapsedTimes()
    {
        ...
        PopulationStats<Object> data = new PopulationStats<Object>(0, new Object(), 0, 0, 0, true, 2, 0, 0, 100);
        assert !condition.shouldTerminate(data) : "Should not terminate before timeout.";
        data = new PopulationStats<Object>(0, new Object(), 0, 0, 0, true, 2, 0, 0, 1000);
